...
def calculate_uk_totals(inputs_folder, lookup_file, output_file):
    """
...
output_file = os.path.join(config["output_directory"], "totals_extracted_UK.csv")

calculate_uk_totals(inputs_folder, lookup_file, output_file)