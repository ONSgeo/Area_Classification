...
|drop_columns | Identifying whether variables will be dropped from the 60 variables before clustering. Set to true to drop the variables specified in 'variables to drop' or set to false to include 60 variables. | 	string   | True or False     |
