...
|pre_clustering_data | The          | 	string   | Any filepath.    |
|pre_clustering_data_filtered | The          | 	string   | Any filepath.     |
|pre_clustering_data_std_mean | The          | 	string   | Any filepath.    |
|restructured_subclustering_output | The          | 	string   | Any filepath.    |
