...
Manual downloads:<br>
The files requiring manual download (listed in [the main Readme](https://github.com/ONSgeo/Area_Classification/blob/main/README.md)) have been downloaded before running the main pipeline.
...
2. For NI, the data is fetched from URLs and downloaded table-by-table. Metadata is fetched and downloaded. The manually downloaded population density table is reformatted to only contain relevent columns and to convert from hectare to hectare to square kilometres (km2).
