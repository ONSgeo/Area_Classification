...
| -------- |   ---------- |     ---------- |
| Area identifier |   string | This will be either 'LTLA', 'LGD' or 'CA19' depending on which country the data is for. |
| Variable fields |   Numeric | These will be all of the counts associated with all the tables which have been fed into inputs.  |
