...
At this stage the data frame containing the subgroup allocation is written in the format number, letter, letter for example 1aa. 
...
The format of the allocation is corrected in the post-processing stage where it turns these into the standard format of number, letter, number e.g. 1a1.
