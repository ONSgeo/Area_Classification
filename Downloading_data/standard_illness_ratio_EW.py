...
# Read the Excel file containing the disability data from disabilitycensus2021.xlsx from the link in line 4, skips the first 4 rows
ill_prop_2021 = pd.read_excel("C:/Users/phills1/Office for National Statistics/Geospatial - LAD_data_downloaded/EW_LAD/disabilitycensus2021.xlsx", sheet_name="Table 6", skiprows=4)
...
# selecting to include only 'persons' (not split by male/female), the 2-category for disability
# and to include only those who are Disabled
...
# this line trying to filter out the rows where there is a string ([c]) instead of a number
ill_prop_2021 = type(ill_prop_2021['Count']) != int 

# aggregating the data to create count and sum of the data by 'Disability_status' and 'sir_age_band'
